...
APPLICATION='/geppettonewticketapplication'
...
DESKTOPIMAGENAME='geppettotest/geppettonewticketapplication-desktop:1.0'
...
helm install --name geppettonewticketapplication-7530 ./helm
if [ $? -eq 0 ]; then
